...
| **`internal/`** | **Your** apps and tools. **`internal/basic-http`** — FastAPI static server; **`internal/globe-landing`** — static globe-landing site served by `python3 -m http.server`. |
